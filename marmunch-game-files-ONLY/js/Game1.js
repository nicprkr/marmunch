...
//title screen
marmunch.Game1 = function(){};

marmunch.Game1.prototype = {
  create: function() {
    ...
    this.sun = this.game.add.sprite(300,100, 'sun');
    this.sun.fixedToCamera = true;
    this.waterfall = this.game.add.sprite(-20, 300, 'waterfall');
    this.waterfall.fixedToCamera = true;
    this.mountain = this.game.add.sprite(100, 150,'mountain');
    this.mountain.fixedToCamera = true;
    this.mountain2 = this.game.add.sprite(500, 150,'mountain');
    this.mountain2.fixedToCamera = true;
